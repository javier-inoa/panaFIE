...
insert into user (id, roleId, name, lastname, state, email, password) values (NEXTVAL('hibernate_sequence'), 2, 'javier', 'Inca Apaza', 1, 'javier@gmail.com' , '12345678');
insert into user (id, roleId, name, lastname, state, email, password) values (NEXTVAL('hibernate_sequence'), 3, 'javier', 'Inca Apaza', 1, 'javier@gmail.com' , '12345678');
insert into user (id, roleId, name, lastname, state, email, password) values (NEXTVAL('hibernate_sequence'), 3, 'javier', 'Inca Apaza', 1, 'javier@gmail.com' , '12345678');
insert into user (id, roleId, name, lastname, state, email, password) values (NEXTVAL('hibernate_sequence'), 3, 'javier', 'Inca Apaza', 1, 'javier@gmail.com' , '12345678');
insert into user (id, roleId, name, lastname, state, email, password) values (NEXTVAL('hibernate_sequence'), 3, 'javier', 'Inca Apaza', 1, 'javier@gmail.com' , '12345678');
insert into user (id, roleId, name, lastname, state, email, password) values (NEXTVAL('hibernate_sequence'), 3, 'javier', 'Inca Apaza', 1, 'javier@gmail.com' , '12345678');
